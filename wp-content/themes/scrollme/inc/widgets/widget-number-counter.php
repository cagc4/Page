        ...
        ?>
            <div class="counter-wrap clearfix">
                ...
                <div class="counter-img clearfix">
                    <input type="text" data-width="100" data-fgColor="#02468c" data-bgColor="#212c35" data-height="50" value="0" data-number="<?php echo $counter; ?>" min="0" max="100" class="ak-counter clearfix">
                </div>
            </div>
        <?php
        echo '</div>';
